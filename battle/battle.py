...
class Battle:
    ...
    def set_battle(
        ...
        return Battle(
            ...
            party_frames[0]._pokemon_list[0],
            party_frames[0]._pokemon_list[1],
            party_frames[0]._pokemon_list[2],
            party_frames[0]._pokemon_list[3],
            party_frames[0]._pokemon_list[4],
            party_frames[0]._pokemon_list[5],
            party_frames[1]._pokemon_list[0],
            party_frames[1]._pokemon_list[1],
            party_frames[1]._pokemon_list[2],
            party_frames[1]._pokemon_list[3],
            party_frames[1]._pokemon_list[4],
            party_frames[1]._pokemon_list[5],
